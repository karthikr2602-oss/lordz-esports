...
export const playersData: Player[] = [
  {
    ...
    game: "FREE FIRE MAX",
    team: "LORD ESPORTZ",
    about: "Master strategist and veteran In-Game Leader for LORD ESPORTZ. Renowned for clutch circle reads and decisive rotational calls.",
  ...
  },
  {
    ...
    game: "FREE FIRE MAX",
    team: "LORD ESPORTZ",
    about: "The clutch tactical anchor of LORD ESPORTZ. Expert in gloo-wall fortification, utility support, and clutch resets under fire.",
