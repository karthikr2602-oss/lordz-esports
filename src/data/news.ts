...
export const newsData: NewsArticle[] = [
  ...
  },
  {
    ...
    excerpt: "With a 4.82 K/D and unmatched late-circle tactical rotations, Beast leads LORD ESPORTZ into the championship tier.",
