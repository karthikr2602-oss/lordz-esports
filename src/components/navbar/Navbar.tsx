                  ...
                  <div className="absolute right-0 mt-2.5 w-80 rounded-2xl border border-[#FFBE32]/30 bg-[#0A0A0D]/95 backdrop-blur-2xl p-4 shadow-[0_20px_60px_rgba(0,0,0,0.95),0_0_25px_rgba(255,190,50,0.15)] z-[8000] animate-in fade-in slide-in-from-top-2 duration-150">
                    ...
                    <div className="space-y-1.5 pt-1">
                      <button
                        ...
                        className="w-full py-2 px-3 rounded-xl bg-[#FFBE32] hover:bg-[#FFE082] text-black font-heading font-bold text-xs uppercase tracking-wider flex items-center justify-center gap-2 cursor-pointer transition-all shadow-[0_0_12px_rgba(255,190,50,0.3)]"
                      >
