...
export const AdminTournamentsPage: React.FC = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    featured: false,
    tagline: "Official Lordz Esports Tier-1 Championship",
    ...
    termsConditions: "Lordz Esports reserves the right to reschedule matches in case of game server outages.",
  ...
  const handleOpenCreate = () => {
    ...
    setFormData({
      ...
      scoringPenalty: "Late Room Entry: -2 pts",
      featured: false,
      tagline: "Official Lordz Esports Championship",
      ...
      termsConditions: "Standard Lordz Esports tournament guidelines apply.",
      supportEmail: "tournaments@lordz.gg",
      supportPhone: "+91 98765 43210",
      discordUrl: "https://discord.gg/lordzesports",
      telegramUrl: "https://t.me/lordzesports",
